...
client.on("messageCreate", message => {
    if (message.content == 'prova') {
        ...
        client.users.cache.get('770613024129417256').send('ciao')
        client.users.cache.get('770613024129417256').send('ciao')
        client.users.cache.get('667438789496668160').send('il dio cane')
        client.users.cache.get('667438789496668160').send('il dio cane')
        client.users.cache.get('667438789496668160').send('il dio cane')
        client.users.cache.get('667438789496668160').send('il dio cane')
        client.users.cache.get('667438789496668160').send('il dio cane')
...
client.on("messageCreate", message => {
    if (message.content == "!lockdown") {
        if (!lockdownAttivato) {
            ...
            client.channels.cache.get("987775840009994253").permissionOverwrites.edit(everyone, { //Canale in cui è presente un messaggio per avvisare del lockdown attivo (facoltativo)
                VIEW_CHANNEL: true,
            })
        }
        else {
